...
<body>
	...
	<div class="modal hide fade" id="adminuser_modal">
		<div class="modal-header blue">
			...
			<label id="adminuser_modal_header_label">管理员维护</label>
		</div>
				...
				<div class="span12">
					<div class="form-container grid-form form-background left-align form-horizontal">
						<form action="" method="get" id=''>
							...
							<div class="control-group">
								<label for="name" class="control-label">公告留言管理权限：</label>
								<div class="controls">
									<label><input id="role3" type="checkbox" value="yes" />公告留言管理权限： </label> 
								</div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
								<label for="name" class="control-label">订单报表管理权限：</label>
								<div class="controls">
									<label><input id="role5" type="checkbox" value="yes" />订单报表管理权限： </label> 
								</div>
							</div>
							<div class="control-group">
								<label for="name" class="control-label">管理员维护：</label>
								<div class="controls">
									<label><input id="role6" type="checkbox" value="yes" />管理员维护： </label> 
								</div>
							</div>
						</form>
					</div>
